...
function createClient(params) {
  ...
  const userAgentHeader = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["getUserAgentHeader"])(`contentful.js/${"8.3.1"}`, config.application, config.integration);
